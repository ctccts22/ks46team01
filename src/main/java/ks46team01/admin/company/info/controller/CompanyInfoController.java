...
public class CompanyInfoController {
    ...
    public String companyInfoList(Model model) {
        ...
        log.info("companyInfo={}", companyInfoDTOList);
    ...
    public String updateCompanyInfo(@RequestParam("companyInfoIdx") Long companyInfoIdx,
                                    ...
                                    Model model) {
        CompanyInfoDTO updatedCompanyInfoDTO = companyInfoService.updateCompanyInfo(companyInfoIdx, companyInfoName, companyInfoLicenseNumber, companyInfoAddress, companyInfoIsDel, companyInfoIsDelDate);
        if (updatedCompanyInfoDTO == null) {
