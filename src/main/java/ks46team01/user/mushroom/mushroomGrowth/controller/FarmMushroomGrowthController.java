    package ks46team01.user.mushroom.mushroomGrowth.controller;
    ...
    import ks46team01.user.mushroom.mushroomGrowth.service.FarmMushroomGrowthService;
    ...
    public class FarmMushroomGrowthController {
        ...
        public String farmGrown(Model model){
            ...
            log.info("fmsg = {} ", fmsg);
            return "user/mushroom/listGrowthMushroom";
        }


        @GetMapping("/add/addGrowthMushroom")
        public String showAddDataGrownForm(Model model){
            ...
            return "user/mushroom/add/addGrowthMushroom";
        }
        @PostMapping("/add/addGrowthMushroom")
        public String addDataGrown(FarmMushroomGrowth farmMushroomGrowth){
            ...
            return "redirect:/mushroom/listGrowthMushroom";
        }


        //수정
        @GetMapping("/modify/modifyGrowthMushroom")
        public String modifyDataGrown(@RequestParam(name="mushroomGrowthIdx" ,required = false)Long mushroomGrowthIdx
            ...
            return "user/mushroom/modify/modifyGrowthMushroom";
        }

        @PostMapping("/modify/modifyGrowthMushroom")
        public String modifyDataGrown(@RequestParam(name="mushroomGrowthIdx" ,required = false)Long mushroomGrowthIdx
                ,@RequestParam(name="username" ,required = false)String username
                ,@RequestParam(name="companyInfoIdx" ,required = false)Long companyInfoIdx
                ,@RequestParam(name="farmDataIdx" ,required = false)Long farmDataIdx
        ...
        //삭제
        @PostMapping("delete/deleteGrowthMushroom")
